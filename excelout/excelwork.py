...
def get_ip_data():
    ...
    input_mac = input("What is the MAC address of your device?")
    input_vpn = input("Are you using a VPN? (Y for yes, N for no)")
    d = {"IP": input_ip, "driver": input_driver, "MAC": input_mac, "VPN": input_vpn}
    return d
...
try:
    ...
    print("File name is not defined or already exists")
